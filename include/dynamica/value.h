...
namespace dynamica {
    ...
    public:
         ...
         */
        inline explicit Value(const std::string &val) : int_val_(0), double_val_(0.0), bool_val_(false) {
            type_ = "string";
            str_val_ = val;
        }
        ...
        inline int toInt() const {
            if (type_ == "string") {
                int i;
                if (scanf(str_val_.c_str(), "%d", &i) == 0) {
                    return (int) boost::hash<std::string>()(str_val_);
                }
                return i;
        ...
        inline double toDouble() const {
            if(type_ == "string") {
                double f;
                if(scanf(str_val_.c_str(),"%f",&f) == 0) {
                    return boost::hash<std::string>()(str_val_);
                }
                return f;
